...
Latin America         ?       ?       ?
Grassly Metastudy[^5] 33      41      47
IDM DTK Model         64.2    76.3    81.3

Table: **Percent seroconverting after 1 dose IPV**

If children are seronegative (i.e. no detectable antibody) but have a history of OPV exposue, they seroconvert at a much higher rate. Below are the results from two studies that looked at seroconversion of OPV-exposed children after one dose of IPV. In the Côte d'Ivoire study, children recieved three doses of OPV. In both Moradabad studies, previous OPV exposure was not controlled for, though reported dose history was collected. 
...
Values for naive seroconversion used in the following are from the Cuba trials alone. Values from OPV-exposed seroconversion are a hybrid of the Côte d'Ivoire and Moradabad findings. Below are the per-dose IPV efficacies for OPV-naive and OPV-exposed children.
...
[^6]: Jafari et al, 2014. Efficacy of inactivated poliovirus vaccin in India. *Science*.